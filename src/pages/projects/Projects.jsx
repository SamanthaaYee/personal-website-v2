...
const projects = [
  {
    title: 'sundial', image: sundialImg, skills: ['React', 'Node.js', 'Express'], 
  ...
  {
    title: 'connectivIT', image: connectivitImg, skills: ['HTML', 'CSS', 'JavaScript'], 
  ...
  {
    image: loveboxdImg, title: 'Loveboxd', skills: ['Figma'], 
